...
boxplot(vals[,"Accuracy"],main="Accuracy",names = nam,ylim = c(0.8,1),col="cornflowerblue",cex.main=1.7)
boxplot(vals[,"Kappa"],main="Kappa",names = nam,ylim = c(0.2,0.8),col="cornflowerblue",cex.main=1.7)
boxplot(vals[,"F1"],main="F1",names = nam,ylim = c(0.8,1),col="cornflowerblue",cex.main=1.7)
boxplot(vals[,"FDR"],main="FDR",names = nam,ylim = c(0,0.2),col="cornflowerblue",cex.main=1.7)
boxplot(vals[,"FNR"],main="FNR",names = nam,ylim = c(0,0.3),col="cornflowerblue",cex.main=1.7)
boxplot(vals[,"FPR"],main="FPR",names = nam,ylim = c(0,1),col="cornflowerblue",cex.main=1.7)
